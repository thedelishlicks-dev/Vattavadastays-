# VattavadaStays — Session Handover v4
**Date:** May 2026
...
- Hosting: Vercel (static SPA) — production URL: `vattavadastays.vercel.app`
- Repo: `github.com/thedelishlicks-dev/Vattavadastays-`
- Domain: NOT purchased yet — all links use `vattavadastays.vercel.app`
...
- invite_link points to `vattavadastays.vercel.app/setup?token=xxx`
...
4. Share login URL and credentials with owner via WhatsApp: `vattavadastays.vercel.app/login`
